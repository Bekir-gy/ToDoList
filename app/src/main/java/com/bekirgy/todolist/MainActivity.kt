    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            ...
            alertDialog.setPositiveButton("Add"){ dialog, i  ->
                ...
                dialog.dismiss()
                Toast.makeText(this,"item kaydedildi",Toast.LENGTH_LONG).show()
            ...
            database.addValueEventListener(object : ValueEventListener{
                ...
                override fun onCancelled(p0: DatabaseError) {
                   Toast.makeText(applicationContext,"item eklenmedi",Toast.LENGTH_LONG).show()
                }
    ...
    private fun addItemToList(p0: DataSnapshot) {
        ...
        if(items.hasNext()){
            ...
            while (itemsIterator.hasNext()){
                val currenItem= itemsIterator.next()
                val toDoItemData= ToDoModel.createList()
                val map = currenItem.getValue() as HashMap<String,Any>

                toDoItemData.UID=currenItem.key
